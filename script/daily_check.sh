...
day=$(date --date='24 hours ago' '+%d-%m-%Y'); cat /home/ionos_server/docker_serveur_web_flask_myip/log/logfile.log | grep $day | awk '{ print "address_identify_web_server;"$1";"$2}' 
